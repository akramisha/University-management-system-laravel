            ...
            <div class="form-layout">
                ...
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                        <form action="{{ route('notifications.update', $notification->id) }}" method="POST" id="notificationForm" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')  
                        ...
                        <input type="text" name="title" id="titleInput" class="form-input" value="{{ $notification->title }}" required>
                    </div>

                                    <div class="form-group">
                        <label class="form-label">Description <span class="required">*</span></label>
                        <textarea name="description" id="descInput" class="form-input" rows="3" required>{{ $notification->description }}</textarea>
                    </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="icon-option">
                                    <input type="radio" name="icon" value="{{ $icon }}" id="icon_{{ $loop->index }}" class="icon-radio" {{ $notification->icon == $icon ? 'checked' : '' }}>
                            ...
                            <div class="form-section">
                               ...
                               @php
    $selectedColor = old('color', $notification->color ?? '');
@endphp
...
<div class="form-group">
    ...
    <div class="color-selection">
       ...
       value="{{ $hex }}"
       {{ strtolower($selectedColor) === strtolower($hex) ? 'checked' : '' }}
       hidden>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePreview() {
        // Update Text
        if(previewTitle) previewTitle.textContent = titleInput.value || "Notification Title";
        if(previewDesc) previewDesc.textContent = descInput.value || "Message description will appear here...";
        
        // Update Priority Badge
        const priority = priorityInput.value;
        if(previewBadge) {
            previewBadge.textContent = priority.charAt(0).toUpperCase() + priority.slice(1);
            if(priority === 'urgent') {
...
if (selectedColor && previewCard && previewIconBox) {
    previewCard.style.borderLeftColor = selectedColor.value;
    previewIconBox.style.backgroundColor = selectedColor.value;
}


        // Update Icon
        const selectedIcon = document.querySelector('.icon-radio:checked');
    ...
    if(priorityInput) priorityInput.addEventListener('change', updatePreview);
    ...
    // Run once on load to show existing data
    updatePreview();

    // 2. Sidebar & Mobile UI Logic
