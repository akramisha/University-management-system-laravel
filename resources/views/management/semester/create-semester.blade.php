        ...
        <div class="dashboard-content">
            ...
            <div class="form-card">
                ...
                <div class="form-card-body">
                    <form action="{{ route('semesters.store') }}" method="POST" id="createSemesterForm">
                        @csrf

                       <div class="form-group">
    <label class="form-label">
        <i class="bi bi-mortarboard"></i> Select Program/Class <span class="required">*</span>
    </label>
   <select name="academic_class_id" id="classSelect" class="form-select">
    <option value="" data-color="#cbd5e0">Select Class</option>
    @foreach($classes as $class)
        <option value="{{ $class->id }}" data-color="{{ $class->color }}">
            {{ $class->name }}
        </option>
    @endforeach
</select>
...
<div class="row">
    ...
    <label class="form-label">
        <i class="bi bi-hash"></i> Semester Number <span class="required">*</span>
    </label>
    <input type="number" name="semester_number" id="semesterNumber" 
...
{{-- REMOVED: Color Selection Group --}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="status-toggle-container">
                                <div class="status-option">
                                    ...
                                    <label for="statusActive" class="status-option-label active-status">
                                        <i class="bi bi-check-circle-fill"></i>
                                        Active
                                    </label>
                                </div>
                                {{-- <div class="status-option">
                                    <input type="radio" name="status" id="statusUpcoming" value="upcoming">
                                    <label for="statusUpcoming" class="status-option-label upcoming-status">
                                ...
                                <div class="status-option">
                                    ...
                                    <label for="statusInactive" class="status-option-label inactive-status">
 ...
 <script>
    ...
    function updatePreview() {
        ...
        const statusValue = statusInput ? statusInput.value : 'active';
        ...
        // Apply Status to all preview locations
