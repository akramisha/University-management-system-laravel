                ...
                <li class="sidebar-menu-item">
                  ...
                  <li class="sidebar-menu-item">
                    ...
                    <div class="sidebar-dropdown">
                        <ul class="sidebar-dropdown-menu">
                            <li class="sidebar-dropdown-item">
                                 <a href="{{url('/management/classes')}}" class="sidebar-dropdown-link active">
                                    <div class="sidebar-menu-icon">
...
function confirmLogout(event) {
        ...
        <div class="dashboard-content">
            ...
            <div class="page-header">
                <div class="page-header-left">
                    <h1 class="page-title">Academic <span class="highlight">Classes</span></h1>
                    <p class="page-subtitle">Manage all academic programs and classes</p>
                </div>
                <a href="{{route('classes.create')}}" class="add-class-btn" >
            ...
            <div class="stats-summary">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-card-content">
                        <div class="stat-card-value">{{ $activeClasses }}</div>
    ...
    @foreach($classes as $class)
                ...
                <div class="class-card " style="border-top: 5px solid {{ $class->color }};">
                    <div class="class-card-header" 
     style="background-color: color-mix(in srgb, {{ $class->color }}, white 90%);">
                        <div class="class-header-top" style=" {{ $class->color }};">
                            <div class="class-icon-wrapper" style="background: {{ $class->color }}20; color: {{ $class->color }}">
                        ...
                        <h3 class="class-code">{{ $class->class_code }} ( {{$class->session}} ) </h3>
                    ...
                    <div class="class-card-body">
                        ...
                        <div class="class-stats">
                            <div class="class-stat-item">
                                <div class="class-stat-value">{{$class->total_semester}}</div>
                                <div class="class-stat-label">Semesters</div>
                            </div>
                            
                            <div class="class-stat-item">
                                <div class="class-stat-value">{{$class->duration}}</div>
                                <div class="class-stat-label">Year Program</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="class-card-footer">
                        ...
                        <div class="class-actions">
                            ...
                            <a href="{{route('classes.edit', $class->id)}}" class="class-action-btn edit" title="Edit" 
        onclick="openEditModal({{ json_encode($class) }})">
    <i class="bi bi-pencil-fill"></i>
</a>
                            <button class="class-action-btn delete" title="Delete" 
        onclick="if(confirm('Are you sure?')) document.getElementById('delete-form-{{ $class->id }}').submit();">
...
@foreach ($classes as $class)
                ...
                <div class="class-list-item" >
                    <div class="class-list-icon" style="background: {{ $class->color }};">
                            <i class="{{ $class->icon }}"></i>
                        </div>
                    <div class="class-list-info">
                        <div class="class-list-header">
                            <span class="class-list-code">{{$class->class_code}}</span>
                            <span class="badge {{ $class->status ? 'bg-success' : 'bg-danger' }}">
                            {{ $class->status ? 'Active' : 'Inactive' }}
                        </span>
                        </div>
                        <div class="class-list-name">{{$class->name}}</div>
                    </div>
                    <div class="class-list-stats">
                        <div class="class-list-stat">
                            <i class="bi bi-calendar3"></i>
                            <span>{{$class->total_semester}}</span> Semesters
                        </div>
                        <div class="class-list-stat">
                            <i class="bi bi-clock"></i>
                            {{$class->duration}} Years Program
                        </div>
                    </div>
    ...
    <div class="modal-overlay" >
        <div class="modal-content">
            <div class="modal-header">
                ...
                <a href="{{route('classes.create')}}" class="modal-close" >
                    <i class="bi bi-x"></i>
                </a>
            </div>
