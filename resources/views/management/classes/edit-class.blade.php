...
function confirmLogout(event) {
    ...
    <main class="main-content">
        ...
        <header class="top-header">
            ...
            <div class="breadcrumb-container">
                ...
                <a href="{{url('/management/classes')}}" class="breadcrumb-item">Class Management</a>
                <i class="bi bi-chevron-right breadcrumb-separator"></i>
    ...
    <span class="header-profile-role">{{ ucfirst(Auth::user()->role) }}</span>
        ...
        <div class="dashboard-content">
            ...
            <div class="page-header">
                ...
                <a href="{{url('/management/classes')}}" class="back-btn">
            ...
            <div class="form-layout">
                ...
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                        <form action="{{ route('classes.update', $class->id) }}" method="POST" id="createClassForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="class_code" class="form-input" id="classCode" value="{{ old('class_code', $class->class_code) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-input" id="className"  value="{{ old('name', $class->name) }}"
       placeholder="e.g., Bachelor of Science in Computer Science" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-textarea" id="classDescription" 
                                        placeholder="Enter a brief description of the program, its objectives, and career opportunities..."> {{ old('description', $class->description) }}</textarea>
                                </div>
                            </div>
    ...
    <select name="duration" class="form-select" id="classDuration" required>
        ...
        @foreach(['2', '3', '4', '5', '6'] as $year)
            <option value="{{ $year }}" {{ old('duration', $class->duration) == $year ? 'selected' : '' }}>
                {{ $year }} Years
            </option>
        @endforeach
    </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total_semester" class="form-input" value="{{ old('total_semester', $class->total_semester) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="session" class="form-input"
                                            id="totalSemesters" placeholder="e.g. 2024-2028" required>
                                        <div class="form-hint">
                                            <i class="bi bi-info-circle"></i>
                                            Usually 2 semesters per year
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="status-toggle-wrapper">
                                        <div class="status-option">
                                            <input type="radio" name="status" value="1" id="statusActive" value="active" {{ $class->status == 'active' ? 'selected' : '' }}
                                        ...
                                        <div class="status-option">
                                            <input type="radio" name="status" value="0" id="statusInactive" value="inactive" {{ $class->status == 'inactive' ? 'selected' : '' }}
                                                class="status-radio">
        ...
        <input type="radio" name="icon" value="bi-heart-pulse-fill" id="iconHeart" class="icon-radio" {{ $class->icon == 'bi-heart-pulse-fill' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
        <input type="radio" name="icon" value="bi-capsule" id="iconCapsule" class="icon-radio" {{ $class->icon == 'bi-capsule' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
        <input type="radio" name="icon" value="bi-bandaid-fill" id="iconBandaid" class="icon-radio" {{ $class->icon == 'bi-bandaid-fill' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
        <input type="radio" name="icon" value="bi-hospital-fill" id="iconHospital" class="icon-radio" {{ $class->icon == 'bi-hospital-fill' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
    <input type="radio" name="icon" value="bi-thermometer-half" id="iconLab" class="icon-radio" {{ $class->icon == 'bi-thermometer-half' ? 'checked' : '' }}>
...
<div class="icon-option">
    <input type="radio" name="icon" value="bi-bag-plus-fill" id="iconKit" class="icon-radio" {{ $class->icon == 'bi-bag-plus-fill' ? 'checked' : '' }}> 
...
<div class="icon-option">
    <input type="radio" name="icon" value="bi-person-plus-fill" id="iconDoctor" class="icon-radio" {{ $class->icon == 'bi-person-plus-fill' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
        <input type="radio" name="icon" value="bi-clipboard2-pulse-fill" id="iconClipboard" class="icon-radio" {{ $class->icon == 'bi-clipboard2-pulse-fill' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
        <input type="radio" name="icon" value="bi-droplet-fill" id="iconDroplet" class="icon-radio" {{ $class->icon == 'bi-droplet-fill' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
        <input type="radio" name="icon" value="bi-truck-front-fill" id="iconAmbulance" class="icon-radio" {{ $class->icon == 'bi-truck-front-fill' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
        <input type="radio" name="icon" value="bi-shield-plus" id="iconShield" class="icon-radio" {{ $class->icon == 'bi-shield-plus' ? 'checked' : '' }}>
    ...
    <div class="icon-option">
        <input type="radio" name="icon" value="bi-activity" id="iconActivity" class="icon-radio" {{ $class->icon == 'bi-activity' ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="color-selection">
                                        <div class="color-option">
                                            <input type="radio" name="color" value="teal" id="colorTeal" {{ old('color', $class->color) == 'teal' ? 'checked' : '' }}
                                        ...
                                        <div class="color-option">
                                            <input type="radio" name="color" value="red" id="colorRed" {{ old('color', $class->color) == 'red' ? 'checked' : '' }}
                                                class="color-radio">
                                        ...
                                        <div class="color-option">
                                            <input type="radio" name="color" value="green" id="colorGreen" {{ old('color', $class->color) == 'green' ? 'checked' : '' }}
                                                class="color-radio">
                                        ...
                                        <div class="color-option">
                                            <input type="radio" name="color" value="purple" id="colorPurple" {{ old('color', $class->color) == 'purple' ? 'checked' : '' }}
                                                class="color-radio">
                                        ...
                                        <div class="color-option">
                                            <input type="radio" name="color" value="orange" id="colorOrange" {{ old('color', $class->color) == 'orange' ? 'checked' : '' }}
                                                class="color-radio">
                                        ...
                                        <div class="color-option">
                                            <input type="radio" name="color" value="pink" id="colorPink" {{ old('color', $class->color) == 'pink' ? 'checked' : '' }}
                                                class="color-radio">
                ...
                <div class="preview-section">
                    <div class="preview-card-wrapper">
                        ...
                        <div class="preview-class-card" id="previewCard">
                            <div class="preview-class-header {{ $class->color }}" id="previewHeader">
                                <div class="preview-header-top">
                                    <div class="preview-icon-wrapper {{ $class->color }}" id="previewIconWrapper">
                                        <i class="{{ $class->icon }}" id="previewIcon"></i>
                                    </div>
                                    <span class="preview-status {{ $class->status == 1 ? 'active' : 'inactive' }}" id="previewStatus">
    <span class="preview-status-dot"></span>
    <span id="previewStatusText">{{ $class->status == 1 ? 'Active' : 'Inactive' }}</span>
</span>
                                </div>
                                <h3 class="preview-class-code" id="previewCode">{{ $class->class_code }}</h3>
                                <p class="preview-class-name" id="previewName">{{ $class->name }}</p>
                            </div>
                            <div class="preview-class-body">
                                ...
                                <div class="preview-stats">
                                    <div class="preview-stat-item">
                                        <div class="preview-stat-value" id="previewSemesters">{{ $class->total_semester }}</div>
                            ...
                            <div class="preview-class-footer">
                                <div class="preview-duration">
                                    ...
                                    <span id="previewDuration">{{ $class->duration }} Years Program</span>
                                </div>
                            </div>
                        </div>
                    </div>
