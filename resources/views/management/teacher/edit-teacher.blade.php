...
@endif
            <!-- Add Teacher Form -->
            <form action="{{ route('teacher.update', $teacher->id) }}" method="POST" enctype="multipart/form-data" id="addTeacherForm">
    @csrf
     @method('PUT')
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    ...
                                    <input type="text" name="first_name" id="firstName" class="form-control" placeholder="Enter first name" value="{{old('first_name', $teacher->teacherProfile->first_name)}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="middle_name" id="MiddleName" value="{{old('middle_name', $teacher->teacherProfile->middle_name)}}" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="last_name" id="lastName" value="{{old('last_name', $teacher->teacherProfile->last_name)}}" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                   <input type="email" name="email" value="{{ $teacher->email }}" class="form-control" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="tel" name="phone_number" class="form-control" placeholder="Enter phone number" value="{{old('phone_number', $teacher->teacherProfile->phone_number)}}"  required>
    ...
    <div class="form-control-wrapper">
        <input type="password" name="password_confirmation" class="form-control" placeholder="Re-enter password" value="{{old('password_confirmation', $teacher->password_confirmation)}}"  >
        <i class="bi bi-shield-lock"></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="tel" name="alternative_phone" class="form-control" value="{{old('alternative_phone', $teacher->teacherProfile->alternative_phone)}}"  placeholder="Enter alternate phone">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="tel" name="cnic" class="form-control" placeholder="Enter CNIC" value="{{old('cnic', $teacher->teacherProfile->cnic)}}" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="date" name="dob" class="form-control" value="{{old('dob', $teacher->teacherProfile->dob)}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="gender"  >
                                    <option value="{{old('gender', $teacher->teacherProfile->gender)}}">Select Gender</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="nationality" value="{{old('nationality', $teacher->teacherProfile->nationality)}}"  class="form-control" placeholder="Enter nationality" value="Pakistan" required>
                            ...
                            <div class="form-group full-width">
                               ...
                               <textarea class="form-control" name="address" placeholder="Enter complete address with city, state and pincode" required>{{ old('address', $teacher->teacherProfile->address ?? '') }}</textarea>
                             </div>
...
<small class="text-muted">ID will be assigned automatically (e.g., TCH-2024-0001)</small>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="designation" required  >
                                    <option value="{{old('designation', $teacher->teacherProfile->designation)}}">Select Designation</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="employee_type" required>
                                    <option value="{{old('employee_type', $teacher->teacherProfile->employee_type)}}" >Select Type</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="date" name="date_of_joining" value="{{old('date_of_joining', $teacher->teacherProfile->date_of_joining)}}" class="form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="number" value="{{old('experience', $teacher->teacherProfile->experience)}}" name="experince" class="form-control" placeholder="Years of experience" min="0" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="specialization" value="{{old('specialization', $teacher->teacherProfile->specialization)}}" class="form-control" placeholder="Enter specialization area" required>
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="degree">
                                    <option value="{{old('degree', $teacher->teacherProfile->degree)}}">Select Degree</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" value="{{old('field_of_study', $teacher->teacherProfile->field_of_study)}}" name="field_of_study" class="form-control" placeholder="Enter field of study" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="university" value="{{old('university', $teacher->teacherProfile->university)}}" class="form-control" placeholder="Enter university name" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="number" name="graduation_year" value="{{old('graduation_year', $teacher->teacherProfile->graduation_year)}}" class="form-control" placeholder="Enter year" min="1970" max="2024" required>
                                    <i class="bi bi-calendar"></i>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="cgpa" value="{{old('cgpa', $teacher->teacherProfile->cgpa)}}" class="form-control" placeholder="Enter percentage or CGPA">
                        ...
                        <div class="form-grid form-grid-2">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="additional1" value="{{old('additional1', $teacher->teacherProfile->additional1)}}" class="form-control" placeholder="Enter degree name">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="institute1" value="{{old('institute1', $teacher->teacherProfile->institute1)}}" class="form-control" placeholder="Institution name, Year">
                                    <i class="bi bi-building"></i>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="additional2" value="{{old('additional2', $teacher->teacherProfile->additional2)}}" class="form-control" placeholder="Enter degree name">
                                    <i class="bi bi-award"></i>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="form-label">Institution & Year</label>
                                <div class="form-control-wrapper">
                                    <input type="text" name="institute2" value="{{old('institute2', $teacher->teacherProfile->institute2)}}" class="form-control" placeholder="Institution name, Year">
                                    <i class="bi bi-building"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-card-body">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="bank_name" value="{{ old('bank_name', $teacher->teacherProfile->bank_name ?? '') }}" class="form-control" placeholder="Enter bank name" required>
                                    <i class="bi bi-bank"></i>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="account_no" value="{{ old('account_no', $teacher->teacherProfile->account_no ?? '') }}" class="form-control" placeholder="Enter account number" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="branch_name" value="{{ old('branch_name', $teacher->teacherProfile->branch_name ?? '') }}" class="form-control" placeholder="Enter branch name">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="number" name="salary" value="{{ old('salary', $teacher->teacherProfile->salary ?? '') }}" class="form-control" placeholder="Enter basic salary">
                                    <i >pkr</i>
                                </div>
                            </div>
                    ...
                    <div class="form-card-body">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="text" name="emergency_person" value="{{ old('emergency_person', $teacher->teacherProfile->emergency_person ?? '') }}" class="form-control" placeholder="Enter contact person name" required>
                                    <i class="bi bi-person"></i>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="emergency_relation">
                                    <option value="{{old('emergency_relation', $teacher->teacherProfile->emergency_relation)}}" >Select Relationship</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <input type="tel" class="form-control" value="{{ old('emergency_no', $teacher->teacherProfile->emergency_no ?? '') }}" name="emergency_no" placeholder="Enter contact number" required>
                                    <i class="bi bi-telephone"></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-grid form-grid-2">
                            ...
                            <div class="checkbox-group">
                                <label class="checkbox-item">
                                    ...
                                    <span class="checkbox-label">Passport Photos</span>
                                </label>
                            </div>
                            <div class="checkbox-group">
                                <label class="checkbox-item">
