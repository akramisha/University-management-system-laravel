    ...
    <div class="dashboard-content">
        <div class="page-header">
            ...
            <div class="action-buttons">
               <a href="{{ route('management.teacher.index') }}" class="btn-action btn-back" style="text-decoration: none;">
                    <i class="bi bi-arrow-left"></i>
                    Back
               </a>
                 <a href="{{ route('teacher.edit', $teacher->id) }}" class="btn-action btn-edit" title="Edit">
...
<form action="{{ route('teacher.destroy', $teacher->id) }}" method="POST" 
    ...
    @if($teacher->teacherProfile && filled($teacher->teacherProfile->profile_photo))
        <img src="{{ asset('storage/' . $teacher->teacherProfile->profile_photo) }}" 
             alt="{{ $teacher->name }}" 
             style="width: 100%; height: 100%; border-radius: 16px; object-fit: cover;">
    @else
        <div class="d-flex align-items-center justify-content-center w-100 h-100" 
             style="background: linear-gradient(135deg, #006d77, #00b4d8); color: white; border-radius: 16px; font-size: 3rem; font-weight: 700;">
            {{ strtoupper($initials) }}
        </div>
    @endif
</div>
                <h2 class="profile-name">{{ $teacher->name ?? 'N/A' }}</h2>
                <p class="profile-role">{{ $teacher->teacherProfile->designation ?? 'N/A' }}</p>

                <div class="profile-status">
                    <span class="status-dot"></span>
                    {{ $teacher->teacherProfile->status ?? 'N/A' }}
                </div>
                ...
                <div class="profile-info-item">
                    ...
                    <div class="profile-info-value">{{ $teacher->teacherProfile->employee_id ?? 'N/A' }}</div>
                </div>

                <div class="profile-info-item">
                    <div class="profile-info-label">CNIC</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->cnic ?? 'N/A' }}</div>
                </div>

                
                <div class="profile-info-item">
                    <div class="profile-info-label">Specialization</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->specialization ?? 'N/A' }}</div>
                </div>

                <div class="profile-info-item">
                    <div class="profile-info-label">Joined Date</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->date_of_joining ?? 'N/A' }}</div>
                </div>
               ...
               <h3 class="form-card-title" style=" border-bottom: none;">
                ...
                <div class="profile-info-item">
                    <div class="profile-info-label">Bank Name</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->bank_name ?? 'N/A' }}</div>
                </div>
                <div class="profile-info-item">
                    <div class="profile-info-label">Account Number</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->account_no ?? 'N/A' }}</div>
                </div>
                <div class="profile-info-item">
                    <div class="profile-info-label">Branch Name</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->branch_name ?? 'N/A' }}</div>
                </div>
                <div class="profile-info-item">
                    <div class="profile-info-label">Salary</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->salary ?? 'N/A' }}</div>
                </div>
               ...
               <h3 class="form-card-title" style=" border-bottom: none;">
                ...
                <div class="profile-info-item">
                    ...
                    <div class="profile-info-value">{{ $teacher->teacherProfile->emergency_person ?? 'N/A' }}</div>
                </div>
                <div class="profile-info-item">
                    <div class="profile-info-label">Person Relationship</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->emergency_relation ?? 'N/A' }}</div>
                </div>
                <div class="profile-info-item">
                    <div class="profile-info-label">Person Number</div>
                    <div class="profile-info-value">{{ $teacher->teacherProfile->emergency_no ?? 'N/A' }}</div>
                </div>
                ...
                <div class="form-card">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->first_name ?? 'N/A' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Last Name</label>
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->last_name ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                     ...
                     <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->phone_number ?? 'N/A' }}" disabled>
                        </div>
                       <div class="form-group">
                            <label class="form-label">Date of Birth</label>
                            <input type="date" class="form-input" value="{{ $teacher->teacherProfile->dob ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->gender ?? 'N/A' }}" disabled>
                        </div>

                        <div class="form-group">
                            <label class="form-label">Nationality</label>
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->nationality ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input"
                                value="{{ $teacher->teacherProfile->address ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->employee_id ?? 'N/A' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Designation</label>
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->designation ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->employee_type ?? 'N/A' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Specialization</label>
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->specialization ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-input" value="{{ $teacher->teacherProfile->date_of_joining ?? 'N/A' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Experience (Years)</label>
                            <input type="number" class="form-input" value="{{ $teacher->teacherProfile->experience ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-input" value="{{ $teacher->email ?? 'N/A' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Alternative Phone Number</label>
                            <input type="tel" class="form-input" value="{{ $teacher->teacherProfile->alternative_phone ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                ...
                <div class="form-card">
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->degree ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->field_of_study ?? 'N/A' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label class="form-label">University</label>
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->university ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->graduation_year ?? 'N/A' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Percentage/CGPA</label>
                            <input type="number" class="form-input" value="{{ $teacher->teacherProfile->cgpa ?? 'N/A' }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row ">
                        <div class="form-group">
                            <label class="form-label">Additional Certifications</label>
                                <input type="text"  class="form-input form-textarea" 
                                disabled value="{{ $teacher->teacherProfile->additional1 ?? 'N/A' }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Institute</label>
                                <input type="text"  class="form-input form-textarea" 
                                disabled value="{{ $teacher->teacherProfile->institute1 ?? 'N/A' }}">
                        </div>
                    </div>
                </div>
            </div>
