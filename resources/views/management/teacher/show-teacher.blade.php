...
function confirmLogout(event) {
    ...
    <div class="search-container">
            <form action="{{ route('management.teacher.index') }}" method="GET">
        ...
        <div class="dashboard-content">
            ...
            <div class="page-header">
                <div class="page-header-left">
                    ...
                    <p class="page-subtitle">Manage professors data and logins</p>
                </div>
                <a href="{{route('management.teacher.create')}}" class="add-class-btn" >
    ...
    <a href="{{ route('management.teacher.index') }}"
...
@endif
    ...
    {{ ucfirst($teacher->teacherProfile->status ?? 'Inactive') }}
                    ...
                    <div class="class-card-footer">
                        ...
                        <div class="class-actions">
                            ...
                            <a href="{{ route('management.teacher.show', $teacher->id) }}" class="class-action-btn view">
    <i class="bi bi-eye"></i>
</a>
                   
                           <a href="{{ route('teacher.edit', $teacher->id) }}" class="class-action-btn edit" title="Edit">
    ...
    <button type="submit" class="class-action-btn delete">
...
@foreach ($teachers as $teacher)
    ...
    <i class="bi bi-eye"></i>
                        ...
                        <a href="{{ route('classes.edit', $teacher->id) }}" class="class-action-btn edit" title="Edit" >
    <i class="bi bi-pencil-fill"></i>
</a>

                        <button class="class-action-btn delete" title="Delete" 
        onclick="if(confirm('Are you sure?')) document.getElementById('delete-form-{{ $teacher->id }}').submit();">
    <i class="bi bi-trash-fill"></i>
</button>

<form id="delete-form-{{ $teacher->id }}" action="{{ route('classes.destroy', $teacher->id) }}" method="POST" style="display: none;">
    @csrf
    @method('DELETE')
</form>
                    </div>
    ...
    <div class="modal-overlay" >
        <div class="modal-content">
            <div class="modal-header">
                ...
                <a href="{{route('management.teacher.create')}}" class="modal-close" >
                    <i class="bi bi-x"></i>
                </a>
            </div>
