...
@media (max-width: 768px) {
    ...
    /* ADD THIS: This is what makes it appear when you click */
    .sidebar.active {
...
/* Initial state: show hamburger, hide cross */
...
/* Active state: hide hamburger, show cross */
.mobile-toggle.active .bi-list {
    display: none;
}
.mobile-toggle.active .bi-x {
    display: inline-block !important; /* Force show the cross */
}
    </style>
</head>
        ...
        <nav class="sidebar-nav">
            ...
            <ul class="sidebar-menu">
                <li class="sidebar-menu-item">
                    <a href="{{route('teacher.dashboard')}}" class="sidebar-menu-link ">
    ...
    @endif
               ...
               <h3 class="form-card-title" style=" border-bottom: none;">
                ...
                <div class="profile-info-item">
                    ...
                    <div class="profile-info-value">{{ $teacher->teacherProfile->account_number ?? 'N/A' }}</div>
                </div>
                <div class="profile-info-item">
                ...
                <div class="form-card">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ $teacher->teacherProfile->alternative_phone ?? 'N/A' }}" disabled>
                        </div>
                    </div>
