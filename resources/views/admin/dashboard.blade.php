                ...
                <li class="sidebar-menu-item">
                    ...
                    <div class="sidebar-dropdown">
                        <ul class="sidebar-dropdown-menu">
                            ...
                            <li class="sidebar-dropdown-item">
                                <a href="{{ route('admin.teachers.index') }}" class="sidebar-dropdown-link">
                                    <div class="sidebar-menu-icon">
                                    <i class="bi bi-circle-fill"></i>
                                    </div>
                                     Tecahers
...
function confirmLogout(event) {
    ...
    function toggleDropdown(element) {
        // Find the parent 'sidebar-menu-item'
        const parent = element.parentElement;
        
        // Toggle the 'open' class on that specific parent
        parent.classList.toggle('open');

        // Optional: Close other dropdowns when opening a new one (Accordion effect)
    ...
    const mobileToggle = document.getElementById('mobileToggle'); // Add id="mobileToggle" to your button
